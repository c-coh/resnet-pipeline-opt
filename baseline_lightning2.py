...
# does not work, it's mad about the device input of all things
...
def main():
    ...
    parser.add_argument("--accelerator", default="auto") # these ones pytorch lightening recommends
    ...
    trainer = L.Trainer(accelerator=accelerator, devices=device, max_epochs=epochs)
